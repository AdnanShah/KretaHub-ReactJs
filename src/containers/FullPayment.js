          ...
          <Paper className={classes.root} elevation={4}>
            ...
            >
              ...
              <div className="col">
                ...
                <p>{jsonData[0].line2}</p>
                <p>{jsonData[0].subHeading1}</p>
                <h2>{jsonData[0].subHeading2}</h2>
              </div>
            </div>
            <br />
            <br />
            <div className="container">
              <div className="row">
                <label className="col-md-4 col-12" htmlFor="email">
                  Order :
                </label>
              ...
              <div className="row">
                <h2 className="col-md-12 col-12" htmlFor="email">
                  <u>
                    Your order details are shown below htmlFor your reference :
                  </u>
                </h2>
              </div>

              <div className="row">
                <label className="col-md-3 col-12" htmlFor="email">
                  Departure :
                </label>
                  ...
                  {data.map(n => {
                    return (
                      <TableRow key={n.id}>
                        ...
                        <TableCell numeric>{n.field3}</TableCell>
                        <TableCell numeric>{n.field4}</TableCell>
                        <TableCell numeric>{n.field5}</TableCell>
                      </TableRow>
                    );
                  })}
                </TableBody>
