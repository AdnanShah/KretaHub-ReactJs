      ...
      steps: [
        {
          title: "Your profile",
          text:
            "Click here to view or edit your profile, change settings, and log out.",
          textAlign: "center",
          selector: ".user-bar",
          position: "left",
          isFixed: true
        },
        {
          title: "Dashboard",
          text:
            "Click here to get to this screen, where you can start booking your freight.",
          textAlign: "center",
        ...
        },
        {
          ...
          textAlign: "center",
          selector: ".container-fluid .origin",
          position: "top",
          isFixed: true
        },
        {
          ...
          textAlign: "center",
          selector: ".container-fluid .destination",
          position: "top",
          isFixed: true
        },
        {
          ...
          textAlign: "center",
          selector: ".container-fluid .freight-type",
          position: "top",
          isFixed: true
        },
        {
          ...
          textAlign: "center",
          selector: ".container-fluid .searchButton",
          position: "top",
          isFixed: true
        },
        {
